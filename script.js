...
function pasangSaldo() {
    ...
    pityCount = 0; // Pity balik ke 0
    document.getElementById('historyList').innerHTML = ""; // Riwayat jadi bersih
    document.getElementById('displayBox').innerHTML = `Saldo diperbarui!<br><span style="font-size:14px; color: #888;">Pity: 0 / ${PITY_LIMIT}</span>`;
